...
class ShoppingList {
	...
	*/
	function updateListName() {
		...
		$sql = "UPDATE $db_table_list_names SET list_name='" . $this->name . "' WHERE list_id=" . $this->id;
	...
	*/
	function deleteShoppingList() {
		global $DB_LINK, $db_table_list_names;
		$sql = "DELETE FROM $db_table_list_names WHERE list_id=" . $this->id;
		$rc = $DB_LINK->Execute($sql);
		DBUtils::checkResult($rc, NULL, NULL, $sql);
	}
	...
	*/
	function deleteListItems() {
		...
		$sql = "DELETE FROM $db_table_list_recipes WHERE list_rp_id=" . $this->id;
		$rc = $DB_LINK->Execute($sql);
		DBUtils::checkResult($rc, NULL, NULL, $sql);
		$sql = "DELETE FROM $db_table_list_ingredients WHERE list_ing_id=" . $this->id;
		$rc = $DB_LINK->Execute($sql);
		DBUtils::checkResult($rc, NULL, NULL, $sql);
	}
	...
	*/
	function loadItems($clear) {
		...
		// Add the recipes
		$sql = "SELECT list_rp_recipe, list_rp_scale FROM $db_table_list_recipes WHERE list_rp_id=" . $this->id;
		$rc = $DB_LINK->Execute($sql);
		DBUtils::checkResult($rc, NULL, NULL, $sql);
		...
		// Add the ingredients
		$sql = "SELECT list_ing_ingredient,list_ing_unit,list_ing_qualifier,list_ing_quantity FROM $db_table_list_ingredients WHERE list_ing_id=" . $this->id;
		$rc = $DB_LINK->Execute($sql);
		DBUtils::checkResult($rc, NULL, NULL, $sql);
		while (!$rc->EOF) {
