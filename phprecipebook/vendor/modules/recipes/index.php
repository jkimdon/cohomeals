...
<?php
$sql_count = "SELECT count(*) FROM $db_table_recipes WHERE recipe_name LIKE '$where%' OR recipe_name LIKE '"
			. strtolower($where) . "%' ORDER BY recipe_name";
			
$sql = "SELECT recipe_id,recipe_name FROM $db_table_recipes WHERE recipe_name LIKE '$where%' OR recipe_name LIKE '"
			. strtolower($where) . "%' ORDER BY recipe_name";
