...
<form name="ingredient_form" action="./index.php?m=ingredients&a=addedit&ingredient_id=<?php echo $ingredient_id;?>" method="post">
...
<?php
	...
	echo "<tr>";
	echo '<td align=left><input type="text" name="ingredient_name" value="'.$ingredient_name.'" maxlength=60 size="20"></td>';
	echo '<td align=left><input type="text" name="ingredient_desc" value="' . $ingredient_desc . '" size="30"></td>';
	echo '<td align=left><input type="text" name="ingredient_price" value="'.$ingredient_price.'" size="4">';
