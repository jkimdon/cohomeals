...
<?php
$sql_count = "SELECT count(*) FROM $db_table_ingredients WHERE ingredient_name LIKE '$where%' OR ingredient_name LIKE '" . strtolower($where) .
			"%' ORDER BY ingredient_name";
$sql = "SELECT ingredient_id,ingredient_name FROM $db_table_ingredients WHERE ingredient_name LIKE '$where%' OR ingredient_name LIKE '" . strtolower($where) .
			"%' ORDER BY ingredient_name";
