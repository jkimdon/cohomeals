<?php /* Smarty version Smarty-3.1-DEV, created on 2015-12-24 02:30:23
         compiled from "/home/jkimdon/newStuff/coho/software/code/tiki-12.4/templates/modules/mod-login_box.tpl" */ ?>
<?php /*%%SmartyHeaderCode:456385948567b58bfb81314-07772717%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '414c09f5f11ab0b7cb1f20f015ed9ba9701f3a6e' => 
    array (
      0 => '/home/jkimdon/newStuff/coho/software/code/tiki-12.4/templates/modules/mod-login_box.tpl',
      1 => 1415104714,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '456385948567b58bfb81314-07772717',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_567b58c00f70a2_37821359',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_567b58c00f70a2_37821359')) {function content_567b58c00f70a2_37821359($_smarty_tpl) {?><?php if (!is_callable('smarty_block_jq')) include 'lib/smarty_tiki/block.jq.php';
...
<?php if ($_smarty_tpl->tpl_vars['prefs']->value['feature_jquery_tooltips']=='y'){?>
	<?php $_smarty_tpl->tpl_vars["closeText"] = new Smarty_variable("Close", null, 0);?>
	<?php $_smarty_tpl->smarty->_tag_stack[] = array('jq', array()); $_block_repeat=true; echo smarty_block_jq(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
if (jqueryTiki.tooltips) {
	$('.login_link').cluetip({
		...
		closeText: '<?php echo $_smarty_tpl->tpl_vars['closeText']->value;?>
',
	...
	<?php if ($_smarty_tpl->tpl_vars['user']->value){?>
		<?php if (empty($_smarty_tpl->tpl_vars['mode']->value)||$_smarty_tpl->tpl_vars['mode']->value=="module"){?>
			...
			<?php if ($_smarty_tpl->tpl_vars['login_module']->value['can_revert']){?>
				<form action="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['login_module']->value['login_url'], ENT_QUOTES, 'UTF-8', true);?>
" method="post">
					<fieldset>
						<legend>Return to Main User</legend>
						<input type="hidden" name="su" value="revert" />
						<input type="hidden" name="username" value="auto" />
						<div style="text-align: center"><button type="submit" class="btn btn-default" name="actsu">Switch</button></div>
					</fieldset>
				</form>
...
"><div class="tabmark"><a href="tiki-logout.php" class="login_link">Log out</a></div>
...
?>
	...
	<?php }else{ ?>
		...
		<?php if ($_smarty_tpl->tpl_vars['mode']->value=="popup"){?>
			<div class="siteloginbar_popup">
				<ul class="clearfix<?php if ($_smarty_tpl->tpl_vars['prefs']->value['feature_jquery_tooltips']!='y'){?> cssmenu_horiz<?php }?>">
					<li id="logout_link_<?php echo $_smarty_tpl->tpl_vars['module_logo_instance']->value;?>
"><div class="tabmark"><a href="tiki-login.php" class="login_link" onclick="return false;" rel=".siteloginbar_poppedup">Log in</a></div>
...
" action="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['login_module']->value['login_url'], ENT_QUOTES, 'UTF-8', true);?>
"
...
" value="on" />
		...
		<?php if ($_smarty_tpl->tpl_vars['module_params']->value['show_forgot']=='y'||$_smarty_tpl->tpl_vars['module_params']->value['show_register']=='y'){?>
			<div <?php if ($_smarty_tpl->tpl_vars['mode']->value=='header'){?>style="text-align: right; display:inline"<?php }?>>
				<?php if ($_smarty_tpl->tpl_vars['module_params']->value['show_forgot']=='y'&&$_smarty_tpl->tpl_vars['prefs']->value['forgotPass']=='y'){?><div class="pass"><a  href="tiki-remind_password.php" title="Click here if you've forgotten your password">I forgot my password</a></div><?php }?><?php if ($_smarty_tpl->tpl_vars['module_params']->value['show_register']=='y'&&$_smarty_tpl->tpl_vars['prefs']->value['allowRegister']=='y'){?><?php if ($_smarty_tpl->tpl_vars['mode']->value=='header'&&$_smarty_tpl->tpl_vars['module_params']->value['show_forgot']=='y'&&$_smarty_tpl->tpl_vars['prefs']->value['forgotPass']=='y'){?>&nbsp;|&nbsp;<?php }?><div class="register"><a href="tiki-register.php<?php if (!empty($_smarty_tpl->tpl_vars['prefs']->value['registerKey'])){?>?key=<?php echo rawurlencode($_smarty_tpl->tpl_vars['prefs']->value['registerKey']);?>
<?php }?>" title="Click here to register"<?php if (!empty($_smarty_tpl->tpl_vars['prefs']->value['registerKey'])){?> rel="nofollow"<?php }?>>Register</a></div><?php }?>
			</div>
		<?php }else{ ?>
			&nbsp;
		<?php }?>
		<?php if ($_smarty_tpl->tpl_vars['prefs']->value['feature_switch_ssl_mode']=='y'&&($_smarty_tpl->tpl_vars['prefs']->value['https_login']=='allowed'||$_smarty_tpl->tpl_vars['prefs']->value['https_login']=='encouraged')){?>
			<div>
				<a class="linkmodule" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['base_url_http']->value, ENT_QUOTES, 'UTF-8', true);?>
<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['prefs']->value['login_url'], ENT_QUOTES, 'UTF-8', true);?>
" title="Click here to login using the default security protocol">Standard</a>
				<a class="linkmodule" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['base_url_https']->value, ENT_QUOTES, 'UTF-8', true);?>
<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['prefs']->value['login_url'], ENT_QUOTES, 'UTF-8', true);?>
