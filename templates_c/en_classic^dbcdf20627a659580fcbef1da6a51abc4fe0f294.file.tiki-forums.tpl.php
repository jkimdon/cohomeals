<?php /* Smarty version Smarty-3.1-DEV, created on 2015-12-24 02:40:42
         compiled from "/home/jkimdon/newStuff/coho/software/code/tiki-12.4/templates/tiki-forums.tpl" */ ?>
<?php /*%%SmartyHeaderCode:915566567b5b2a4e67c3-10370810%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'dbcdf20627a659580fcbef1da6a51abc4fe0f294' => 
    array (
      0 => '/home/jkimdon/newStuff/coho/software/code/tiki-12.4/templates/tiki-forums.tpl',
      1 => 1412603328,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '915566567b5b2a4e67c3-10370810',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_567b5b2a7fa2d2_16730148',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_567b5b2a7fa2d2_16730148')) {function content_567b5b2a7fa2d2_16730148($_smarty_tpl) {?><?php if (!is_callable('smarty_block_title')) include 'lib/smarty_tiki/block.title.php';
...
">
							<input type="submit" class="btn btn-default" value="Search by name" name="search">
				...
				<?php if ($_smarty_tpl->tpl_vars['prefs']->value['feature_forums_search']=='y'&&$_smarty_tpl->tpl_vars['prefs']->value['feature_search']=='y'){?>
					<td>
						<form class="forms" method="get" action="<?php if ($_smarty_tpl->tpl_vars['prefs']->value['feature_search_fulltext']!='y'){?>tiki-searchindex.php<?php }else{ ?>tiki-searchresults.php<?php }?>">
							...
							<input type="submit" class="wikiaction btn btn-default" name="search" value="Search in content">
						</form>
					</td>
				<?php }?>
			</tr>
...
<br>
			...
			<td class="action">
				<?php if ($_smarty_tpl->tpl_vars['prefs']->value['mobile_mode']=='y'){?><div class="navbar" data-role="controlgroup" data-type="horizontal"><?php }?> 
					<a <?php if ($_smarty_tpl->tpl_vars['prefs']->value['mobile_mode']=='y'){?> data-role="button"<?php }?> class="admlink" title="View" href="<?php echo smarty_modifier_sefurl($_smarty_tpl->tpl_vars['channels']->value[$_smarty_tpl->getVariable('smarty')->value['section']['user']['index']]['forumId'],'forum');?>
"><?php echo smarty_function_icon(array('_id'=>'table','alt'=>"View"),$_smarty_tpl);?>
					...
					<?php if (($_smarty_tpl->tpl_vars['tiki_p_admin']->value=='y')||(($_smarty_tpl->tpl_vars['channels']->value[$_smarty_tpl->getVariable('smarty')->value['section']['user']['index']]['individual']=='n')&&($_smarty_tpl->tpl_vars['tiki_p_admin_forum']->value=='y'))||($_smarty_tpl->tpl_vars['channels']->value[$_smarty_tpl->getVariable('smarty')->value['section']['user']['index']]['individual_tiki_p_admin_forum']=='y')){?>
						<a <?php if ($_smarty_tpl->tpl_vars['prefs']->value['mobile_mode']=='y'){?> data-role="button"<?php }?> class="admlink" title="Configure Forum" href="tiki-admin_forums.php?forumId=<?php echo $_smarty_tpl->tpl_vars['channels']->value[$_smarty_tpl->getVariable('smarty')->value['section']['user']['index']]['forumId'];?>
