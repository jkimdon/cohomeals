<?php /* Smarty version Smarty-3.1-DEV, created on 2015-12-26 01:00:37
         compiled from "/home/jkimdon/newStuff/coho/software/code/cohomeals/templates/tiki-calendar_calmode.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1195696375567de6b5a5d260-57168219%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b556b4bc8f7670ad10eebad79f0a0fbe5691049b' => 
    array (
      0 => '/home/jkimdon/newStuff/coho/software/code/cohomeals/templates/tiki-calendar_calmode.tpl',
      1 => 1397563532,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1195696375567de6b5a5d260-57168219',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_567de6b60f5825_06341445',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_567de6b60f5825_06341445')) {function content_567de6b60f5825_06341445($_smarty_tpl) {?><?php if (!is_callable('smarty_function_cycle')) include '/home/jkimdon/newStuff/coho/software/code/cohomeals/vendor/smarty/smarty/distribution/libs/plugins/function.cycle.php';
...
" style="height:80px">
  <td width="1%" class="heading weeks"><a <?php if ($_smarty_tpl->tpl_vars['prefs']->value['mobile_mode']=="y"){?>data-role="button" data-inline="true" <?php }?>href="<?php echo $_smarty_tpl->tpl_vars['myurl']->value;?>
...
" style="padding:0px">
	  <table cellpadding="0" cellspacing="0" style="width:100%;border:none">
		...
		<?php if (($_smarty_tpl->tpl_vars['prefs']->value['display_field_order']=='DMY')||($_smarty_tpl->tpl_vars['prefs']->value['display_field_order']=='DYM')||($_smarty_tpl->tpl_vars['prefs']->value['display_field_order']=='YDM')){?>
			<a <?php if ($_smarty_tpl->tpl_vars['prefs']->value['mobile_mode']=="y"){?>data-role="button" data-inline="true" data-mini="true" data-theme="b" <?php }?>href="<?php echo $_smarty_tpl->tpl_vars['myurl']->value;?>
...
" title="Change Focus" style="font-size:11px"><?php echo smarty_modifier_tiki_date_format($_smarty_tpl->tpl_vars['cell']->value[$_smarty_tpl->getVariable('smarty')->value['section']['w']['index']][$_smarty_tpl->getVariable('smarty')->value['section']['d']['index']]['day'],"%d/%m");?>
		...
		<?php }else{ ?> <a <?php if ($_smarty_tpl->tpl_vars['prefs']->value['mobile_mode']=="y"){?>data-role="button" data-inline="true" data-mini="true" data-theme="b" <?php }?>href="<?php echo $_smarty_tpl->tpl_vars['myurl']->value;?>
?focus=<?php echo $_smarty_tpl->tpl_vars['cell']->value[$_smarty_tpl->getVariable('smarty')->value['section']['w']['index']][$_smarty_tpl->getVariable('smarty')->value['section']['d']['index']]['day'];?>
" title="Change Focus" style="font-size:11px"><?php echo smarty_modifier_tiki_date_format($_smarty_tpl->tpl_vars['cell']->value[$_smarty_tpl->getVariable('smarty')->value['section']['w']['index']][$_smarty_tpl->getVariable('smarty')->value['section']['d']['index']]['day'],"%m/%d");?>
		...
		<?php }?>			
		  ...
		  <td class="focus <?php if ($_smarty_tpl->tpl_vars['cell']->value[$_smarty_tpl->getVariable('smarty')->value['section']['w']['index']][$_smarty_tpl->getVariable('smarty')->value['section']['d']['index']]['day']==$_smarty_tpl->tpl_vars['today']->value){?>calhighlight<?php }?>" style="width:50%;text-align:right">
 
			<?php if ($_smarty_tpl->tpl_vars['prefs']->value['mobile_mode']=="y"){?><div class="navbar" data-role="controlgroup" data-type="horizontal"><?php }?> 
				...
				<a <?php if ($_smarty_tpl->tpl_vars['prefs']->value['mobile_mode']=="y"){?>data-role="button" data-mini="true" <?php }?>href="tiki-calendar_edit_item.php?todate=<?php echo $_smarty_tpl->tpl_vars['cell']->value[$_smarty_tpl->getVariable('smarty')->value['section']['w']['index']][$_smarty_tpl->getVariable('smarty')->value['section']['d']['index']]['day'];?>
...
<?php }?>" title="Add Event" class="addevent"><?php echo smarty_function_icon(array('_id'=>'calendar_add','alt'=>"+",'title'=>"Add Event"),$_smarty_tpl);?>
				...
				<?php }?>
				<a <?php if ($_smarty_tpl->tpl_vars['prefs']->value['mobile_mode']=="y"){?>data-role="button" data-mini="true" <?php }?>class="viewthisday" href="tiki-calendar.php?viewmode=day&amp;todate=<?php echo $_smarty_tpl->tpl_vars['cell']->value[$_smarty_tpl->getVariable('smarty')->value['section']['w']['index']][$_smarty_tpl->getVariable('smarty')->value['section']['d']['index']]['day'];?>
<?php if (count($_smarty_tpl->tpl_vars['displayedcals']->value)==1){?>&amp;calendarId=<?php echo $_smarty_tpl->tpl_vars['displayedcals']->value[0];?>
<?php }?>" title="View this Day"><?php echo smarty_function_icon(array('_id'=>'img/icons/external_link.gif','width'=>7,'height'=>8,'alt'=>"o",'title'=>"View this Day"),$_smarty_tpl);?>
			...
			<?php if ($_smarty_tpl->tpl_vars['prefs']->value['mobile_mode']=="y"){?></div><?php }?> 
		  </td>
		  <?php }?>
		</tr>
	  </table>
...
<?php }?><?php if ($_smarty_tpl->tpl_vars['cell']->value[$_smarty_tpl->getVariable('smarty')->value['section']['w']['index']][$_smarty_tpl->getVariable('smarty')->value['section']['d']['index']]['items'][$_smarty_tpl->getVariable('smarty')->value['section']['item']['index']]['status']=='2'){?> text-decoration:line-through;<?php }?>"
			<?php if ($_smarty_tpl->tpl_vars['myurl']->value=="tiki-action_calendar.php"){?>
...
"<?php }?>
			<?php }else{ ?>
				href="#"
			<?php }?>
			><?php echo htmlspecialchars_decode((($tmp = @htmlspecialchars(smarty_modifier_truncate($_smarty_tpl->tpl_vars['cell']->value[$_smarty_tpl->getVariable('smarty')->value['section']['w']['index']][$_smarty_tpl->getVariable('smarty')->value['section']['d']['index']]['items'][$_smarty_tpl->getVariable('smarty')->value['section']['item']['index']]['name'],$_smarty_tpl->tpl_vars['trunc']->value,".."), ENT_QUOTES, 'UTF-8', true))===null||$tmp==='' ? "..." : $tmp), ENT_QUOTES);?>
</a>
			...
			<a <?php if ($_smarty_tpl->tpl_vars['prefs']->value['mobile_mode']=="y"){?>data-role="button" data-mini="true" <?php }?>href="<?php echo $_smarty_tpl->tpl_vars['cell']->value[$_smarty_tpl->getVariable('smarty')->value['section']['w']['index']][$_smarty_tpl->getVariable('smarty')->value['section']['d']['index']]['items'][$_smarty_tpl->getVariable('smarty')->value['section']['item']['index']]['web'];?>
...
"><img src="img/icons/external_link.gif" width="7" height="7" alt="&gt;"></a>
			...
			<a <?php if ($_smarty_tpl->tpl_vars['prefs']->value['mobile_mode']=="y"){?>data-role="button" data-mini="true" <?php }?>href="tiki-newsletters.php?nlId=<?php echo $_smarty_tpl->tpl_vars['cell']->value[$_smarty_tpl->getVariable('smarty')->value['section']['w']['index']][$_smarty_tpl->getVariable('smarty')->value['section']['d']['index']]['items'][$_smarty_tpl->getVariable('smarty')->value['section']['item']['index']]['nl'];?>
