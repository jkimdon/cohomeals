<?php /* Smarty version Smarty-3.1-DEV, created on 2015-12-24 02:41:04
         compiled from "/home/jkimdon/newStuff/coho/software/code/tiki-12.4/templates/find.tpl" */ ?>
<?php /*%%SmartyHeaderCode:935711725567b5b408dc417-94707373%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f6fe0d3bdb58fb3e291afec8eca8195a9f6b7c84' => 
    array (
      0 => '/home/jkimdon/newStuff/coho/software/code/tiki-12.4/templates/find.tpl',
      1 => 1384970597,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '935711725567b5b408dc417-94707373',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_567b5b40c96306_08471730',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_567b5b40c96306_08471730')) {function content_567b5b40c96306_08471730($_smarty_tpl) {?><?php if (!is_callable('smarty_function_query')) include 'lib/smarty_tiki/function.query.php';
...
?>
			<option value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['topic']->value['topicId'], ENT_QUOTES, 'UTF-8', true);?>
" <?php if ($_smarty_tpl->tpl_vars['find_topic']->value==$_smarty_tpl->tpl_vars['topic']->value['topicId']){?>selected="selected"<?php }?>>
				<?php echo htmlspecialchars(smarty_modifier_tr_if($_smarty_tpl->tpl_vars['topic']->value['name']), ENT_QUOTES, 'UTF-8', true);?>
...
" <?php if ($_smarty_tpl->tpl_vars['find_categId']->value==$_smarty_tpl->tpl_vars['identifier']->value){?>selected="selected"<?php }?>>
		...
		<?php if ($_smarty_tpl->tpl_vars['prefs']->value['javascript_enabled']=='y'&&$_smarty_tpl->tpl_vars['find_show_categories_multi']->value=='y'){?><a href="#" onclick="show('category_multiselect_find');hide('category_singleselect_find');javascript:document.getElementById('category_select_find_type').value='y';">Multiple select</a><?php }?>
...
<?php if (!empty($_smarty_tpl->tpl_vars['show_find_orphans']->value)&&$_smarty_tpl->tpl_vars['show_find_orphans']->value=='y'){?>
	<label class="find_orphans" for="find_orphans">
		   Orphans
		   <input type="checkbox" name="find_orphans" id="find_orphans" <?php if (isset($_smarty_tpl->tpl_vars['find_orphans']->value)&&$_smarty_tpl->tpl_vars['find_orphans']->value=='y'){?>checked="checked"<?php }?>>
	</label>
<?php }?>
...
" title="Clear Filter">Clear Filter</a>
	...
	<?php if ((isset($_smarty_tpl->tpl_vars['gmapbuttons']->value)&&$_smarty_tpl->tpl_vars['gmapbuttons']->value)&&(isset($_smarty_tpl->tpl_vars['mapview']->value)&&$_smarty_tpl->tpl_vars['mapview']->value)){?>
		<input class="btn btn-default" type="submit" name="searchlist" value="List View">
	...
	<?php }elseif((isset($_smarty_tpl->tpl_vars['gmapbuttons']->value)&&$_smarty_tpl->tpl_vars['gmapbuttons']->value)){?>
		<input type="submit" class="btn btn-default" name="searchmap" value="Map View">
