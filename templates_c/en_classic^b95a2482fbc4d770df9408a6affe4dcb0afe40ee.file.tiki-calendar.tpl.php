<?php /* Smarty version Smarty-3.1-DEV, created on 2015-12-26 01:00:36
         compiled from "/home/jkimdon/newStuff/coho/software/code/cohomeals/templates/tiki-calendar.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1921398037567de6b4da9e72-82713412%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b95a2482fbc4d770df9408a6affe4dcb0afe40ee' => 
    array (
      0 => '/home/jkimdon/newStuff/coho/software/code/cohomeals/templates/tiki-calendar.tpl',
      1 => 1398032185,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1921398037567de6b4da9e72-82713412',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_567de6b51b2234_53775736',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_567de6b51b2234_53775736')) {function content_567de6b51b2234_53775736($_smarty_tpl) {?><?php if (!is_callable('smarty_block_title')) include 'lib/smarty_tiki/block.title.php';
...
<div id="calscreen">
	...
	<div class="navbar">
		<?php if ($_smarty_tpl->tpl_vars['prefs']->value['mobile_mode']=="y"){?><div data-role="controlgroup" data-type="horizontal" style="float:right"><?php }?> 
			<?php if (count($_smarty_tpl->tpl_vars['displayedcals']->value)==1&&$_smarty_tpl->tpl_vars['prefs']->value['feature_group_watches']=='y'&&($_smarty_tpl->tpl_vars['tiki_p_admin_users']->value=='y'||$_smarty_tpl->tpl_vars['tiki_p_admin']->value=='y')){?>
				<a <?php if ($_smarty_tpl->tpl_vars['prefs']->value['mobile_mode']=="y"){?>data-role="button" data-mini="true" data-inline="true" <?php }?>href="tiki-object_watches.php?objectId=<?php echo rawurlencode($_smarty_tpl->tpl_vars['displayedcals']->value[0]);?>
...
" class="icon"><?php echo smarty_function_icon(array('_id'=>'eye_group','alt'=>"Group Monitor",'align'=>'right','hspace'=>"1"),$_smarty_tpl);?>
			...
			<?php if (count($_smarty_tpl->tpl_vars['displayedcals']->value)==1&&$_smarty_tpl->tpl_vars['user']->value&&$_smarty_tpl->tpl_vars['prefs']->value['feature_user_watches']=='y'){?>
				<?php if ($_smarty_tpl->tpl_vars['user_watching']->value=='y'){?>
					<a <?php if ($_smarty_tpl->tpl_vars['prefs']->value['mobile_mode']=="y"){?>data-role="button" data-mini="true" data-inline="true" <?php }?>href="tiki-calendar.php?watch_event=calendar_changed&amp;watch_action=remove" class="icon"><?php echo smarty_function_icon(array('_id'=>'no_eye','alt'=>"Stop Monitoring this Page",'align'=>"right",'hspace'=>"1"),$_smarty_tpl);?>
</a> 
				<?php }else{ ?>
					<a <?php if ($_smarty_tpl->tpl_vars['prefs']->value['mobile_mode']=="y"){?>data-role="button" data-mini="true" data-inline="true" <?php }?>href="tiki-calendar.php?watch_event=calendar_changed&amp;watch_action=add" class="icon"><?php echo smarty_function_icon(array('_id'=>'eye','alt'=>"Monitor this Page",'align'=>"right",'hspace'=>"1"),$_smarty_tpl);?>
</a> 
				<?php }?>
			<?php }?>
...
">
				<input type="submit" class="btn btn-default" name="refresh" value="Refresh">
			</div>
		</form>
	<?php }?>
...
">advanced parameters</a>
			...
			<div class="calinput">
				<input type="submit" class="btn btn-default" name="ical" value="Export as iCal">
				<input type="submit" class="btn btn-default" name="csv" value="Export as CSV">
			</div>
		</form>
	<?php }?>
