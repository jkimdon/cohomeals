<?php /* Smarty version Smarty-3.1-DEV, created on 2015-12-26 00:58:12
         compiled from "/home/jkimdon/newStuff/coho/software/code/cohomeals/templates/error.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1515616059567de6241eca29-00601229%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '393c98420c7094fe1fc8fce891eae72a8b8fc3b5' => 
    array (
      0 => '/home/jkimdon/newStuff/coho/software/code/cohomeals/templates/error.tpl',
      1 => 1431799826,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1515616059567de6241eca29-00601229',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_567de62589e049_12034628',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_567de62589e049_12034628')) {function content_567de62589e049_12034628($_smarty_tpl) {?><?php if (!is_callable('smarty_block_jq')) include 'lib/smarty_tiki/block.jq.php';
...
<?php }?><?php }?><?php if (($_smarty_tpl->tpl_vars['prefs']->value['feature_search']=='y'||$_smarty_tpl->tpl_vars['prefs']->value['feature_search_fulltext']=='y')&&$_smarty_tpl->tpl_vars['tiki_p_search']->value=='y'){?><?php if ($_smarty_tpl->tpl_vars['prefs']->value['feature_search_fulltext']=='y'){?><?php echo $_smarty_tpl->getSubTemplate ('tiki-searchresults.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('searchNoResults'=>"false",'searchStyle'=>"menu",'searchOrientation'=>"horiz",'words'=>((string)$_smarty_tpl->tpl_vars['page']->value)), 0);?>
<?php }else{ ?><?php echo $_smarty_tpl->getSubTemplate ('tiki-searchindex_form.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('searchNoResults'=>"true",'searchStyle'=>"menu",'searchOrientation'=>"horiz",'words'=>((string)$_smarty_tpl->tpl_vars['page']->value),'filter'=>$_smarty_tpl->tpl_vars['filter']->value), 0);?>
<?php }?><?php }?><?php }elseif($_smarty_tpl->tpl_vars['commenttype']->value=="note"&&isset($_smarty_tpl->tpl_vars['msg']->value)){?><?php $_smarty_tpl->smarty->_tag_stack[] = array('remarksbox', array('type'=>'note','title'=>$_smarty_tpl->tpl_vars['title']->value)); $_block_repeat=true; echo smarty_block_remarksbox(array('type'=>'note','title'=>$_smarty_tpl->tpl_vars['title']->value), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
<?php echo $_smarty_tpl->tpl_vars['msg']->value;?>
<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_remarksbox(array('type'=>'note','title'=>$_smarty_tpl->tpl_vars['title']->value), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
<?php }else{ ?><?php if (isset($_smarty_tpl->tpl_vars['token_error']->value)){?><?php $_smarty_tpl->smarty->_tag_stack[] = array('remarksbox', array('type'=>'errors','title'=>"Token Error")); $_block_repeat=true; echo smarty_block_remarksbox(array('type'=>'errors','title'=>"Token Error"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
<?php }elseif(!isset($_smarty_tpl->tpl_vars['user']->value)&&$_smarty_tpl->tpl_vars['errortype']->value!='no_redirect_login'&&$_smarty_tpl->tpl_vars['errortype']->value!='login'&&empty($_smarty_tpl->tpl_vars['msg']->value)){?><?php $_smarty_tpl->smarty->_tag_stack[] = array('remarksbox', array('type'=>'errors','title'=>$_smarty_tpl->tpl_vars['errortitle']->value)); $_block_repeat=true; echo smarty_block_remarksbox(array('type'=>'errors','title'=>$_smarty_tpl->tpl_vars['errortitle']->value), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
<form method="post" action="tiki-admin.php"><input type="hidden" name="ticket" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['ticket']->value, ENT_QUOTES, 'UTF-8', true);?>
...
<?php } ?><input type="submit" class="btn btn-default" value="Set"></form><?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_remarksbox(array('type'=>'note','title'=>"Change them here"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
<?php }?><?php if (isset($_smarty_tpl->tpl_vars['page']->value)&&$_smarty_tpl->tpl_vars['page']->value&&$_smarty_tpl->tpl_vars['create']->value=='y'&&($_smarty_tpl->tpl_vars['tiki_p_admin']->value=='y'||$_smarty_tpl->tpl_vars['tiki_p_admin_wiki']->value=='y'||$_smarty_tpl->tpl_vars['tiki_p_edit']->value=='y')){?><?php echo smarty_function_button(array('href'=>"tiki-editpage.php?page=".((string)$_smarty_tpl->tpl_vars['page']->value),'_text'=>"Create this page"),$_smarty_tpl);?>
 (page will be orphaned)<br><br><?php }?><?php if (!isset($_smarty_tpl->tpl_vars['page']->value)||$_smarty_tpl->tpl_vars['prefs']->value['site_wikiHomePage']!=$_smarty_tpl->tpl_vars['page']->value){?><?php if ($_smarty_tpl->tpl_vars['prefs']->value['javascript_enabled']=='y'){?><?php echo smarty_function_button(array('_onclick'=>"javascript:history.back();return false;",'_text'=>"Go back",'_ajax'=>"n"),$_smarty_tpl);?>
