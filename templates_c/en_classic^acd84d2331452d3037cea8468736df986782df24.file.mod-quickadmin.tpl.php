<?php /* Smarty version Smarty-3.1-DEV, created on 2015-12-24 02:30:31
         compiled from "/home/jkimdon/newStuff/coho/software/code/tiki-12.4/templates/modules/mod-quickadmin.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1684266475567b58c7d9ed93-33350764%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'acd84d2331452d3037cea8468736df986782df24' => 
    array (
      0 => '/home/jkimdon/newStuff/coho/software/code/tiki-12.4/templates/modules/mod-quickadmin.tpl',
      1 => 1397136389,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1684266475567b58c7d9ed93-33350764',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_567b58c7ebd450_80159409',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_567b58c7ebd450_80159409')) {function content_567b58c7ebd450_80159409($_smarty_tpl) {?><?php if (!is_callable('smarty_block_tikimodule')) include 'lib/smarty_tiki/block.tikimodule.php';
	...
	<?php if ($_smarty_tpl->tpl_vars['tiki_p_admin']->value=="y"){?>
		<div id="quickadmin" style="text-align: left; padding-left: 12px;">
			<ul class="cssmenu_horiz clearfix" style="display: inline-block;line-height: 30px;">
				<li>
					<?php if ($_smarty_tpl->tpl_vars['prefs']->value['feature_jquery_superfish']=="y"){?>
						<a>&nbsp;</a>
					<?php }else{ ?>
						<?php echo smarty_function_icon(array('_id'=>'arrow_down','title'=>"Recent preferences",'href'=>"#"),$_smarty_tpl);?>
...
?>
							<li>
								<a href="tiki-admin.php?lm_criteria=<?php echo smarty_modifier_stringfix($_smarty_tpl->tpl_vars['p']->value,"_","%20AND%20");?>
"><?php echo smarty_modifier_stringfix($_smarty_tpl->tpl_vars['p']->value);?>
</a>
							</li>
						<?php }
...
?>
			...
			<?php echo smarty_function_icon(array('_id'=>'wizard16x16','title'=>"Wizards",'href'=>"tiki-wizard_admin.php?stepNr=0&amp;url=index.php"),$_smarty_tpl);?>
