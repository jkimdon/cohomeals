<?php /* Smarty version Smarty-3.1-DEV, created on 2015-12-26 00:58:26
         compiled from "/home/jkimdon/newStuff/coho/software/code/cohomeals/templates/tiki-user_cssmenu.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1295790178567de633003c98-57688082%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '028bf6875f4960a5dfb3491fdfa6dc19b75f2433' => 
    array (
      0 => '/home/jkimdon/newStuff/coho/software/code/cohomeals/templates/tiki-user_cssmenu.tpl',
      1 => 1398438078,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1295790178567de633003c98-57688082',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_567de63381a833_75456063',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_567de63381a833_75456063')) {function content_567de63381a833_75456063($_smarty_tpl) {?><?php if (!is_callable('smarty_block_repeat')) include 'lib/smarty_tiki/block.repeat.php';
...
<?php if (isset($_smarty_tpl->tpl_vars['chdata']->value['selected'])&&$_smarty_tpl->tpl_vars['chdata']->value['selected']){?> selected<?php }?><?php if (isset($_smarty_tpl->tpl_vars['chdata']->value['selectedAscendant'])&&$_smarty_tpl->tpl_vars['chdata']->value['selectedAscendant']){?> selectedAscendant<?php }?>"><?php if (empty($_smarty_tpl->tpl_vars['chdata']->value['block'])){?><a<?php if (!empty($_smarty_tpl->tpl_vars['chdata']->value['url'])){?> href="<?php if ($_smarty_tpl->tpl_vars['prefs']->value['feature_sefurl']=='y'&&$_smarty_tpl->tpl_vars['chdata']->value['sefurl']){?><?php if ($_smarty_tpl->tpl_vars['prefs']->value['menus_item_names_raw']=='n'){?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['chdata']->value['sefurl'], ENT_QUOTES, 'UTF-8', true);?>
...
<?php }?></span><?php if ($_smarty_tpl->tpl_vars['link_on_section']->value!='n'){?></a><?php }?><?php }else{ ?><?php if ($_smarty_tpl->tpl_vars['translate']->value=='n'){?><?php if ($_smarty_tpl->tpl_vars['escape_menu_labels']->value){?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['chdata']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['chdata']->value['name'];?>
<?php }?><?php }else{ ?><?php $_smarty_tpl->smarty->_tag_stack[] = array('tr', array()); $_block_repeat=true; echo smarty_block_tr(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
<?php if ($_smarty_tpl->tpl_vars['escape_menu_labels']->value){?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['chdata']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['chdata']->value['name'];?>
<?php }?><?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_tr(array(), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
<?php }?><?php }?><?php $_smarty_tpl->tpl_vars['opensec'] = new Smarty_variable($_smarty_tpl->tpl_vars['opensec']->value+1, null, 0);?><ul><?php }elseif($_smarty_tpl->tpl_vars['chdata']->value['type']=='o'){?><li class="option<?php echo $_smarty_tpl->tpl_vars['chdata']->value['optionId'];?>
 menuOption menuLevel<?php echo $_smarty_tpl->tpl_vars['opensec']->value;?>
<?php if (isset($_smarty_tpl->tpl_vars['chdata']->value['selected'])&&$_smarty_tpl->tpl_vars['chdata']->value['selected']){?> selected<?php }?><?php if (isset($_smarty_tpl->tpl_vars['chdata']->value['selectedAscendant'])&&$_smarty_tpl->tpl_vars['chdata']->value['selectedAscendant']){?> selectedAscendant<?php }?>"><?php if (empty($_smarty_tpl->tpl_vars['chdata']->value['block'])){?><a href="<?php if ($_smarty_tpl->tpl_vars['prefs']->value['feature_sefurl']=='y'&&$_smarty_tpl->tpl_vars['chdata']->value['sefurl']){?><?php if ($_smarty_tpl->tpl_vars['prefs']->value['menus_item_names_raw']=='n'){?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['chdata']->value['sefurl'], ENT_QUOTES, 'UTF-8', true);?>
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['chdata']->value['sefurl'];?>
<?php }?><?php }else{ ?><?php if ($_smarty_tpl->tpl_vars['prefs']->value['menus_item_names_raw']=='n'){?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['chdata']->value['url'], ENT_QUOTES, 'UTF-8', true);?>
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['chdata']->value['url'];?>
...
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['chdata']->value['name'];?>
<?php }?><?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_tr(array(), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
<?php }?></span></a><?php }else{ ?><?php if ($_smarty_tpl->tpl_vars['translate']->value=='n'){?><?php if ($_smarty_tpl->tpl_vars['escape_menu_labels']->value){?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['chdata']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['chdata']->value['name'];?>
<?php }?><?php }else{ ?><?php $_smarty_tpl->smarty->_tag_stack[] = array('tr', array()); $_block_repeat=true; echo smarty_block_tr(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
<?php if ($_smarty_tpl->tpl_vars['escape_menu_labels']->value){?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['chdata']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['chdata']->value['name'];?>
<?php }?><?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_tr(array(), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
<?php }?><?php }?></li><?php if ($_smarty_tpl->tpl_vars['sep']->value=='line'){?><?php $_smarty_tpl->tpl_vars['sep'] = new Smarty_variable('', null, 0);?><?php }?><?php }elseif($_smarty_tpl->tpl_vars['chdata']->value['type']=='-'){?><?php if ($_smarty_tpl->tpl_vars['opensec']->value>0){?></ul></li><?php $_smarty_tpl->tpl_vars['opensec'] = new Smarty_variable($_smarty_tpl->tpl_vars['opensec']->value-1, null, 0);?><?php }?><?php $_smarty_tpl->tpl_vars['sep'] = new Smarty_variable("line", null, 0);?><?php }?><?php } ?><?php if ($_smarty_tpl->tpl_vars['opensec']->value>0){?><?php $_smarty_tpl->smarty->_tag_stack[] = array('repeat', array('count'=>$_smarty_tpl->tpl_vars['opensec']->value)); $_block_repeat=true; echo smarty_block_repeat(array('count'=>$_smarty_tpl->tpl_vars['opensec']->value), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
