...
{if $printDay[d].events[ev].start eq $printDay[d].events[ev].end}
  {$printDay[d].events[ev].start|tiki_date_format:"%l:%M%p"} -- 
{else}
  {$printDay[d].events[ev].start|tiki_date_format:"%l:%M%p"}-{$printDay[d].events[ev].end|tiki_date_format:"%l:%M%p"} -- 
{/if}
</td>
...
<b>Guest Room</b> - </td>
<td style="vertical-align:top;">Please welcome {$printDay[d].guestroom[gr].visitor|escape}, guest of {$printDay[d].guestroom[gr].host|escape}. Expected to arrive on {$printDay[d].guestroom[gr].start|tiki_date_format:"%a, %b %e"} at {$printDay[d].guestroom[gr].start|tiki_date_format:"%l:%M%p"} and leave on {$printDay[d].guestroom[gr].end|tiki_date_format:"%a, %b %e"} at {$printDay[d].guestroom[gr].end|tiki_date_format:"%l:%M%p"}
</td></tr></table>
{/section}
...
<td style="vertical-align:top;">Please welcome {$printDay[d].camping[gr].visitor|escape}, guest of {$printDay[d].camping[gr].host|escape}. Expected to arrive on {$printDay[d].camping[gr].start|tiki_date_format:"%a, %b %e"} at {$printDay[d].camping[gr].start|tiki_date_format:"%l:%M%p"} and leave on {$printDay[d].camping[gr].end|tiki_date_format:"%a, %b %e"} at {$printDay[d].camping[gr].end|tiki_date_format:"%l:%M%p"}
</td></tr></table>
{/section}
