{* $Id: admin_category.tpl 51486 2014-05-26 10:21:22Z xavidp $ *}

<div class="adminWizardIconleft"><img src="img/icons/large/wizard_admin48x48.png" alt="{tr}Admin Wizard{/tr}" title="{tr}Admin Wizard{/tr}" /></div><div class="adminWizardIconright"><img src="img/icons/large/categories48x48.png" alt="{tr}Set up Categories{/tr}" /></div>
