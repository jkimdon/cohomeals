{* $Id: tiki.tpl 30217 2010-10-22 16:11:28Z luciash $ *}{if $prefs.feature_custom_doctype eq 'y' and !empty($prefs.feature_custom_doctype_content)}{$prefs.feature_custom_doctype_content}{else}<!DOCTYPE html 
