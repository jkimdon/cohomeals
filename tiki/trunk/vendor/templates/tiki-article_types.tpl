{* $Id: tiki-article_types.tpl 30309 2010-10-26 16:38:40Z marclaporte $ *}
...
<a class="link" href="tiki-view_articles.php?type={$types[user].type|escape:url}">{tr}view articles with this type{/tr}</a>
	...
	<table class="normal">
		...
		<td><a class="link" href="tiki-article_types.php?att_type={$types[user].type|escape:url}&att_remove={$att.relationId|escape:url}">{icon _id='cross' alt="{tr}Remove{/tr}"}</a></td>
		</tr>
		{/foreach}
		<tr>
