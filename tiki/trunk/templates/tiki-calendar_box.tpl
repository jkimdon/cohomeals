...
{* old format	{$cellstart|tiki_date_format:"%l:%M %p"} &ndash; {$cellend|tiki_date_format:"%l:%M %p"} *}
  {else}
{* old format	{$cellstart|tiki_date_format:"%e %B (%l:%M %p)"} &ndash; {$cellend|tiki_date_format:"%e %B (%l:%M %p)"} *}
