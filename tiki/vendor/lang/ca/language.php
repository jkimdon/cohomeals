...
"admin polls tpl" => "administrar plantilla per a consultes",
...
"polls" => "consultes",
"Poll settings" => "Configuració de la Consulta",
...
"Use dbl click to edit pages" => "Empra doble click per editar pàgines",
...
"Wiki page list configuration" => "Configuració de llista de pàgines Wiki",
...
"Updated" => "Actualitzat",
"Renders a graph, with linked pages navigation visually figured.\n" => "Produeix un gràfic, amb navegació de mode visual per les pàgines enllaçades.\n",
...
"admin activities" => "administració d'activitats",
...
"tiki.org help" => "ajuda en tiki.org",
...
"Use ...page... to separate pages in a multi-page article" => "Empra ...page... per separar pàgines en un article multi-pàgina",
"answer" => "resposta",
...
"For database update from 1.7.x, please visit <a target=\"help\" href=\"http://tiki.org/UpgradeTo18\">Tiki database 1.7.x to 1.8x instructions" => "Per actualitzacions de la base de dades des de 1.7.x, si us plau consulta les <a target=\"help\" href=\"http://tiki.org/UpgradeTo18\">instruccions per passar de la base dades de Tiki 1.7.x a 1.8.x",
"For information about tiki-secdb_*.sql files, please see <a target=\"help\" href=\"http://tiki.org/AdminSecurity\">http://tiki.org/AdminSecurity" => "Per informació sobre els arxius tiki-secdb_*.sql , pots consultar <a target=\"help\" href=\"http://tiki.org/AdminSecurity\">http://tiki.org/AdminSecurity",
...
"Read the <a class=\"link\" href=\"http://doc.tiki.org/Configuration\" title=\"TikiWiki Documentation\" target=\"_blank\">configuration documentation</a>" => "Llegeix la <a class=\"link\" href=\"http://doc.tiki.org/Configuration\" title=\"Documentació de TikiWiki\" target=\"_blank\">documentació de la configuració</a>",
"To learn more, visit: <a href=\"http://www.tiki.org\" title=\"The TikiWiki Community\" target=\"_blank\">http://www.tiki.org</a>" => "Per aprendre més, visita: <a href=\"http://www.tiki.org\" title=\"La Comunitat TikiWiki\" target=\"_blank\">http://www.tiki.org</a>",
"TikiWiki Documentation" => "Documentació de TikiWiki",
"For help, visit <a href=\"http://doc.tiki.org\" title=\"TikiWiki Documentation\" target=\"_blank\">http://doc.tiki.org</a>" => "Per ajuda, visita <a href=\"http://doc.tiki.org\" title=\"Documentació de TikiWiki\" target=\"_blank\">http://doc.tiki.org</a>",
...
"admin polls template" => "administra la plantilla de les consultes",
"configure polls" => "configura les consultes",
...
"For database update from 1.7.x, please visit <a target=\"help\" href=\"http://doc.tiki.org/Upgrade+1.7+to+1.8\">Tiki database 1.7.x to 1.8x instructions" => "Per actualitzar bases de dades des de 1.7.x, si us plau, consulta <a target=\"help\" href=\"http://doc.tiki.org/Upgrade+1.7+to+1.8\">les instruccions per bases de dades Tiki de la 1.7.x a la 1.8.x",
"For information about tiki-secdb_*.sql files, please see <a target=\"help\" \nhref=\"http://doc.tiki.org/Security+Admin\">http://doc.tiki.org/Security+Admin" => "Per informació sobre els arxius tiki-secdb_*.sql, mira si us plau <a target=\"help\" \nhref=\"http://doc.tiki.org/Security+Admin\">http://doc.tiki.org/Security+Admin",
...
"Edit or add poll options" => "Editar o afegir opcions a la consulta",
"Create/edit Polls" => "Crea o edita consultes",
...
"To learn more about <a class=\"rbox-link\" target=\"tikihelp\" href=\"http://mods.tiki.org\">mods</a>." => "Per aprendre més sobre <a class=\"rbox-link\" target=\"tikihelp\" href=\"http://mods.tiki.org\">Mods</a>.",
...
"Users can lock pages (if perm)" => "Els usuaris poden bloquejar pàgines (si tenen perm)",
...
"subscribed" => "subscrit",
"Admin Polls Template" => "Administra la Plantilla de les Consultes",
"Configure Polls" => "Configura Consultes",
...
"See <a target=\"help\" class=\"link\" href=\"http://doc.tiki.org/Upgrade+1.7+to+1.8\">Tiki database 1.7.x to 1.8x instructions" => "Consulta les <a target=\"help\" class=\"link\" href=\"http://doc.tiki.org/Upgrade+1.7+to+1.8\">instruccions de bases de dades Tiki 1.7.x a 1.8.x",
"For information about <strong>tiki-secdb_*.sql</strong> files, please see <a target=\"help\" class=\"link\" href=\"http://doc.tiki.org/Security+Admin\">http://doc.tiki.org/Security+Admin" => "Per informació sobre els arxius <strong>tiki-secdb_*.sql</strong>, si us plau consulta <a target=\"help\" class=\"link\" href=\"http://doc.tiki.org/Security+Admin\">http://doc.tiki.org/Security+Admin",
...
"To learn more, visit: <a href=\"http://www.tiki.org\" title=\"The Tikiwiki Community\" target=\"_blank\">http://www.tiki.org</a>" => "Per aprendre més, visita: <a href=\"http://www.tiki.org\" title=\"La Comunitat de Tikiwiki\" target=\"_blank\">http://www.tiki.org</a>",
...
"Please expect not found help-pages with the default-URL." => "Si us plau, és normal no trobar totes les pàgines d'ajuda amb la URL per defecte.",
...
"To add/edit wiki pages easily, add the module quick_edit via \"Modules\" on the application menu, or" => "Per afegir/editar pàgines wiki fàcilment, afegeix el mòdul d'edició ràpida (quick_edit) via \"Mòduls\" en el menú principal de l'aplicació, o",
...
"Wiki Page List Configuration" => "Configuració de la llista de pàgines Wiki",
...
"See the documentation for <a target=\"_blank\" href=\"http://doc.tiki.org/Profiles\" class=\"link\" title=\"{tr}Description of available profiles." => "Consulta la documentació per a la <a target=\"_blank\" href=\"http://doc.tiki.org/Profiles\" class=\"link\" title=\"{tr}Descripció dels perfils disponibles.",
...
"Return to HomePage" => "Torna a la PaginaInicial",
...
"Allow Anonymous Poll Voting" => "Permet consultes anònimes",
...
"To learn more about <a class=\"rbox-link\" target=\"tikihelp\" href=\"http://themes.tiki.org\">themes</a>." => "Per aprendre més sobre <a class=\"rbox-link\" target=\"tikihelp\" href=\"http://themes.tiki.org\">Temes</a> (d'estil, estètica).",
...
"To learn more, visit: <a href=\"http://tiki.org\" title=\"The TikiWiki Community\" target=\"_blank\">http://tiki.org</a>" => "Per aprendre més, visita: <a href=\"http://tiki.org\" title=\"La Comunitat TikiWiki\" target=\"_blank\">http://tiki.org</a>",
...
"Tiki was able to send a test message to info@tiki.org" => "Tiki ha pogut enviar un missatge de prova a info@tiki.org",
...
"TikiWiki is software distributed under the LGPL license" => "Tiki és programari distribuït sota la llicència LGPL",
...
"To test your system configuration, TikiWiki will attempt to send a test message to info@tiki.org" => "Per comprovar la teva configuració del sistema, TikiWiki provarà d'enviar un missatge de prova a info@tiki.org",
...
"Visit <a href=\"http://profiles.tiki.org\" target=\"_blank\">http://profiles.tiki.org</a> for more information" => "Visita <a href=\"http://profiles.tiki.org\" target=\"_blank\">http://profiles.tiki.org</a> per a més informació",
...
"To test your system configuration, Tiki will attempt to send a test message to info@tiki.org" => "Per provar la teva configuració, Tiki provarà d'enviar un misatge de prova a info@tiki.org",
...
"Use this page to create a new database connection, or use the <a href=\"http://doc.tiki.org/Manual+Installation\" title=\"manual installation\">manual installation process</a>" => "Empra aquesta pàgina per crear una nova connexió a base de dades, o empra el <a href=\"http://doc.tiki.org/Manual+Installation\" title=\"manual installation\">procés d'instal·lació manual</a>",
...
"santa" => "santa",
"Dif" => "Dif",
"Text_Wiki libraries need to be installed. Please see http://dev.tiki.org/MediaWiki+to+TikiWiki+converter" => "Cal instal·lar les llibreries Text_Wiki. Si us plau, consulta http://dev.tiki.org/MediaWiki+to+TikiWiki+converter",
...
"Ranking frequency" => "Ranking per freqüència",
"Realtime" => "Temps real",
...
"To learn more about the <a class=\"rbox-link\" target=\"tikihelp\" href=\"http://workflow.tiki.org\">Galaxia workflow engine</a>" => "Per aprendre més sobre el <a class=\"rbox-link\" target=\"tikihelp\" href=\"http://workflow.tiki.org\">Motor de Flux de treball</a>",
...
"Use page description:" => "Empra descripció de pàgines:",
...
"or use" => "o empra",
"an existing poll" => "una consulta existent",
...
"Your help is needed! Please visit <a href=\"http://dev.tiki.org/tiki-index.php?page=Mods\">dev.tiki.org</a> to find out more." => "Es necessita la teva ajuda! Si us plau, visita <a href=\"http://dev.tiki.org/tiki-index.php?page=Mods\">dev.tiki.org</a> per saber-ne mes.",
...
"Register this site at tiki.org" => "Registra aquest lloc a tiki.org",
"On this page you can make your tiki site known to tiki.org. It will get shown there in a list of known tiki sites." => "En aquesta pàgina pots donar a conèixer el teu lloc tiki a tiki.org per tal que consti al llistat de llocs tiki coneguts",
"public" => "públic",
...
"Check this box if you really want to delete your account" => "Marca aquesta casella si realment vols esborrar el teu compte",
"Reports are disabled, only standard reporting is available" => "Els informes estan desactivats, només és disponible l'enviament de missatges estàndard",
"Sites you are watching" => "Llocs i pàgines que estàs vigilant",
"Documents interns" => "Documents interns",
"Documents" => "Documents",
"Removed version" => "Versió eliminada",
"Renamed" => "Reanomenat",
"Viewed" => "Visualitzat",
...
"You need to check out the recorded box for each action type we may be interested to have some report later. To see a report of some action types, select the reported checkboxes of these action types, goto the Report tab and select additional filters. The " => "Necessites marcar el requadre de verificació corresponent a cada tipus d'acció sobre la qual puguis estar interessat en que hi hagi algun informe posterior. Per veure un informe d'alguns tipus d'accions, selecciona les caselles de verificació d'aquests",
...
"This search feature and the <a href=\"tiki-edit_perspective.php\">perspectives GUI</a> need <a href=\"http://dev.tiki.org/Dynamic+Preferences\">dev.tiki.org/Dynamic+Preferences</a>. If you search for something and it's not appearing, please help improve keywords/descriptions" => "Aquesta funcionalitat de cerca i la <a href=\"tiki-edit_perspective.php\">interfície gràfica de gestió de Perspectives</a> necessiten les preferències dinàmiques (<a href=\"http://dev.tiki.org/Dynamic+Preferences\">dev.tiki.org/Dynamic+Preferences</a>). Si cerques alguna cosa i no apareix, si us plau, ajuda a millorar les paraules clau i descripcions de les preferències",
...
"However, some page aliases fitting the query were found (see Aliases section above)" => "De totes formes, es van trobar alguns alias de pàgines que encaixen en la cerca (mira la secció d'Alias més amunt)",
"Change to" => "Canvia a",
...
"Changes to groups watching this {\$objectType}" => "Canvis en grups subscrits a aquest/a {\$objectType}",
...
"Groups watching this {\$objectType}" => "Grups seguint aquest/a {\$objectType}",
"Make sure to whitelist this domain to prevent registration emails being canned by your spam filter" => "Assegura't de posar a la llista blanca d'adreces conegudes a aquest domini per prevenir que els correus-e de registre vagin a parar a la teva carpeta de correu no desitjat (spam)",
...
"Separate multiple recipients with a comma" => "Separa múltiples destinataris amb comes",
...
"Development Notice" => "Avís de desenvolupament",
"Experimental Conversion" => "Conversió experimental",
...
"Tiki credits payment done on %0 for \$amount (using \$creditType)" => "El pagament amb crèdits de Tiki s'ha efectuat el %0 per \$amount (emprant \$creditType)",
...
"List all pages that link to specific pages" => "Llista totes les pàgines que apunten a pàgines específiques",
...
"Poll" => "Consulta",
"Displays the output of a poll, fields are indicated with numeric ids." => "Mostra la sortida d'una Consulta, els camps estan indicats amb ids numèrics.",
...
"Read the <a class=\"link\" href=\"http://doc.tiki.org/Configuration\" title=\"Tikiwiki Documentation\" target=\"_blank\">configuration documentation</a>" => "Llegeix la <a class=\"link\" href=\"http://doc.tiki.org/Configuration\" title=\"Documentació de Tikiwiki\" target=\"_blank\">documentatió de configuració</a>",
...
"Edit or export/import Languages" => "Edita o exporta/importa Idiomes",
...
"Parent SheetId" => "SheetId parental",
...
"Mark other translations as out of date" => "Marca les altres traduccions com a desfasades",
...
"A user edited an article" => "Un usuari edita un article",
"A user deleted an article" => "Un usuari esborra un article",
...
"Permission denied you cannot approve staging pages" => "Permís denegat: no pots aprovar pàgines pendents de revisió",
