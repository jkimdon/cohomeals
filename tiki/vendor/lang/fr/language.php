...
"<strong>Activate</strong> will display content for Admin only. Select <strong>Publish</strong> to display for all users" => "<strong>Activer</strong> n'affichera le contenu que pour l'Admin. Sélectionnez <strong>Publier</strong> pour l'afficher pour tous les utilisateurs",
...
"\$feature set to nothing" => "\$feature n'est pas positionnée",
...
"A new major release branch is available" => "Une nouvelle branche de la version majeure est disponible",
"A new version of Tikiwiki, <b>{\$prefs.tiki_release}</b>, is available. You are currently running <b>{\$tiki_version}</b>. Please visit <a href=\"http://tiki.org/Download\">http://tiki.org/Download</a>" => "Une nouvelle version de Tikiwiki, <b>{\$prefs.tiki_release}</b>, est disponible. Vous êtes à la version <b>{\$tiki_version}</b>. Rendez vous sur <a href=\"http://tiki.org/Download\">http://tiki.org/Download</a>",
...
"About WikiPlugins and security: Make sure to only grant the \"tiki_p_plugin_approve\" permission to trusted editors" => "À propos des WikiPlugins et de la sécurité : assurez-vous de n'accorder le droit \"tiki_p_plugin_approve\" qu'à des éditeurs de confiance",
"Absolute URL to the image or relative path from tikiwiki root" => "URL absolue vers l'image ou chemin relatif par rapport à la racine de tikiwiki",
...
"Activate MySQL 'Full-Text' feature" => "Activer la fonctionnalité MySQL 'Full-Text'",
...
"Also available here" => "Disponible aussi là",
"Alternate text that displays when image does not load" => "Texte à afficher lorsque l'image n'est pas chargée",
...
"Assign into category" => "Assigner à une categorie",
...
"Assign to a group" => "Assigner à un group",
...
"Assignments" => "Devoirs",
"Aug" => "août",
"Authentication error; not a valid OpenID" => "Erreur d'authentification; identifiant OpenID invalide",
"Author, if different from the Creator" => "Auteur, si différent du créateur",
...
"Enable Features" => "Activer la fonctionnalité",
...
"Enable payments through paypal" => "Activer les payements via paypal",
...
"Enables searching for content on the website" => "Active la recherche de contenu dans le site",
...
"Experimental. This feature is still under development" => "Expérimentale. Cette fonctionnalité est en cours de développement",
...
"Hint: If you lose your login module, use tiki-login_scr.php to be able to login" => "Astuce : Si vous perdez le module de login, utilisez tiki-login_src.php pour vous connecter",
"hist" => "hist",
...
"Name of the profile" => "Nom du profile",
...
"New forum post in <{\$mail_forum|truncate:20:\"...\"}> by {\$mail_author}" => "Nouveau message dans le forum <{\$mail_forum|truncate:20:\"...\"}> par {\$mail_author}",
"New forum topic in <{\$mail_forum|truncate:20:\"...\"}> by {\$mail_author}" => "Nouveau sujet dans le forum <{\$mail_forum|truncate:20:\"...\"}> par {\$mail_author}",
"New jQuery.sheet based editing - experimental feature" => "Édition basée sur jQuery.sheet - fonctionnalité expérimentale",
...
"Newsletter successfully sent to %s users" => "La Newsletter a été envoyée avec succès à %s utilisateurs",
...
"Note that plugin arguments can be enclosed with double quotes \"; this allows them to contain , or " => "Les arguments des plugins peuvent être délimités par des guillemets double \", cela leur permet de contenir des , ou ",
...
"Please select a point to set both Lon. and Lat" => "S'il vous plait sélectionner un point pour régler la longitude et la latitude",
...
"Plugin <strong>%0</strong> cannot be executed" => "Le Plugin <strong>%0</strong> n'a pas pu être exécuté",
"Plugin <strong>%0</strong> does not exist" => "Le Plugin <strong>%0</strong> n'existe pas",
"Plugin argument(s) missing" => "Argument(s) du Plugin manquant(s)",
"Plugin modified by editor" => "Plugin modifié par l'éditeur",
"Plugin name not specified" => "Nom du Plugin non specifié",
"Plugin Tools" => "Outils pour les Plugin",
...
"Some of your groups have been automatically hidden.<br /> Select the groups below to assign permissions for" => "Certains de vos groupes ont été automatiquement cachés.<br /> Sélectionnez des groupes ci dessous pour leur assigner des droits",
"some text" => "texte",
...
"Sort mode. Example: lastModif_desc, created_asc, fieldname_desc, etc" => "Mode de tri. Exemple: lastModif_desc, created_asc, fieldname_desc, etc.",
...
"This search feature and the <a href=\"tiki-edit_perspective.php\">perspectives GUI</a> need <a href=\"http://dev.tiki.org/Dynamic+Preferences\">http://dev.tiki.org/Dynamic+Preferences</a>. If you search for something and it's not appearing, please help improve keywords/descriptions" => "Cette recherche de fonctionnalités ainsi que <a href=\"tiki-edit_perspective.php\">l'interface des prespectives</a> ont besoin d'une page <a href=\"http://dev.tiki.org/Dynamic+Preferences\">http://dev.tiki.org/Dynamic+Preferences</a>. Si votre recherche est infructueuse, aidez nous à améliorer les descriptions et les mots clef des préférences",
...
"rssfeed webmaster" => "rssfeed webmestre",
...
"Shows Hits" => "Afficher les visites",
...
"Administrator and accounts managers." => "Administrateurs et gestionnaires de comptes",
"First Page" => "Première page",
"Next Page" => "Page suivante",
"Prev Page" => "Page précédente",
"Public users not logged" => "Utilisateurs publiques non inscrits (visiteurs)",
"Users logged into the system" => "Utilisateurs inscrits dans le système",
...
"When accessing a page which has an equivalent in the user's preferred language, favor the translated page" => "When accessing a page which has an equivalent in the user's preferred language, favor the translated page",
"Whether obey article type's \"show before publish\" and \"show after expiry\" settings" => "Whether obey article type's \"show before publish\" and \"show after expiry\" settings",
"ReCaptcha public key" => "Clef publique du ReCaptcha",
"ReCaptcha private key" => "Clef privée du ReCaptcha",
...
"Last items published on this tracker" => "Dernier éléments publiés dans ce formulaire",
"You have mistyped the anti-bot verification code. Please try again" => "Vous vous êtes trompé dans la code de vérification anti-bot. Veuillez réessayer",
"Incorrect. Try again" => "Incorrect. Essayez encore",
"Create page" => "Créer la page",
"Choose a smaller number for less noise and easier reading" => "Choisissez un petit nombre pour moin de bruit et une lecture plus facile",
"Hide the title field on comments and their replies" => "Cacher le titre des commentaires ainsi que leurs réponses",
"Email field for comments (only for anonymous users)" => "Champ Email pour les commentaires (seulement pour les anonymes)",
"Enables searching for content on the website, using Tiki-managed index" => "Permet la recherche de contenu sur le site, en utilisant les index gérés par Tiki",
"Unless you have a reason to, you should use MySQL Full-Text Search feature instead" => "Sauf à avoir une bonne raison, vous devez utiliser la recherche « Full-Text » de MySQL",
...
"Email address for person responsible for editorial content" => "Adresse e-mail de la personne responsable du contenu rédactionnel",
...
"Full URL of the repository" => "URL complète du dépot",
"Please see <a href=\"http://doc.tikiwiki.org/\">the documentation</a> for more information" => "Reportez-vous à <a href=\"http://doc.tikiwiki.org/\">la documentation</a> pour plus d'informations",
...
"Configuration <em>%0</em> is enabled. Disabling modification checks can improve performance, but will require manual clear on file updates" => "La configuration de <em>%0</em> est active. La désactivation des vérifications de modifications peut améliorer les performances, mais il sera nécessaire de purger manuellemnt les caches lors de la mise à jour des fichiers",
...
"Bytecode cache is not used. Using a bytecode cache (APC, XCache) is highly recommended for production environments" => "Aucun cache de Bytecode n'est utilisé. L'utilisation d'un cache (APC, XCache) est fortement recommandé dans environnement de production",
...
"This also allows a mixture of wiki and html. Only some wiki syntax is parsed, such as plugins (not inline character styles etc)" => "Ceci permet aussi le mélange du HTML et de la syntaxe wiki. Seuls quelques éléments de la syntaxe wiki seront interprétés, comme les plugins (mais pas les styles de caractères, etc.)",
"Most of these features are hoped to make it into the \"new\" section for Tiki 6" => "La plupart de ces fonctionnalités devraient faire leur apparition dans la section \"Nouveau\" pour Tiki 6",
...
"Use three colons instead of two to center text. Avoids conflict with C++ resolution scope operator" => "Utiliser trois double-point à la place de deux pour centrer le texte. Ceci évite les conflits avec les opérateurs de portée C++",
...
"Parse wiki syntax within the code snippet" => "Interpréter la syntaxe wiki à l'intèrieur des bouts de code",
...
"Getting there.." => "On va y arriver...",
"Cannot open/write this file" => "Impossible d'ouvrir ou d'écrire dans ce fichier",
"Some of your preferences should be set differently for this to work at it's best. Please click this to apply the recommended profile" => "Certaines de vos préférences devraient être modifiées pour un fonctionnement optimal de CKEditor. Cliquez ici afin d'appliquer le profil recommandé",
"Edit this Forum" => "Éditer ce forum",
"Default ordering for topics" => "Ordre par défaut des sujets",
"Edit this feed" => "Éditer ce flux",
"Custom Tools" => "Outils personnalisés",
"Warning: There is no undo" => "Attention: impossible d'annuler",
"Is mandatory/required" => "Obligatoire",
"Is column searchable" => "Recherche possible dans la colonne",
...
"Admin Posts" => "Administrer les messages",
...
"Edit this user module" => "Éditer ce module utilisateur",
"Available polls" => "Sondages disponibles",
"Default Tiki menus" => "Menu Tiki par défaut",
"CSS menus" => "Menus CSS",
"PHP Layers menus" => "Menus PHP Layers",
...
"To use a <a target=\"tikihelp\" href=\"http://phplayersmenu.sourceforge.net/\">PHP Layers menu</a>, use one of these syntaxes (Note: PHP Layers menus are being replaced by CSS menus and may have only basic styling in newer themes.)" => "Pour utiliser <a target=\"tikihelp\" href=\"http://phplayersmenu.sourceforge.net/\">un menu PHP Layers</a>, utilisez une des syntaxes suivants (Note: les menus PHP Layers sont remplacés par les menus CSS et ne peuvent disposer que de style simple dans les nouveaux thèmes.)",
"You can deactivate risky plugins at (<a href=\"tiki-admin.php?page=textarea\">tiki-admin.php?page=textarea</a>)" => "Vous pouvez désactiver les plugins risqués sur la page (<a href=\"tiki-admin.php?page=textarea\">tiki-admin.php?page=textarea</a>)",
"Add as new items" => "Ajouter en tant que nouveaux éléments",
...
"Default ordering for threads" => "Ordre par défaut des enfilades",
"Default style for threads" => "Style par défaut des enfilades",
"Edit this HTML page" => "Éditer cette page HTML",
"To submit your site to Tiki.org" => "Pour soumettre votre site à Tiki.org",
...
"If you set feed author email or url you have to set feed author name" => "Si vous fournissez le mail ou l'URL de l'auteur du flux RSS, vous devez aussi fournir son nom",
...
"feature custom html head content" => "fonctionnalité en-tête HTML presonnalisée",
"feature gmap" => "fonctionnalité gmap",
"feature jquery carousel" => "fonctionnalité carousel jquery",
"feature wiki save draft" => "fonction de sauvegarde des brouillons wiki",
"feature wysiwyg" => "Fonctionnalité wysiwyg",
"sitelogo align" => "alignement du logo du site",
"sitelogo src" => "Source du logo du site",
"sitelogo title" => "Titre du logo du site",
"tiki minify css" => "réduction des CSS",
"tiki minify css single file" => "réduction des CSS dans un fichier unique",
"tiki minify javascript" => "réduction du javascript",
"wysiwyg default" => "réglages par défaut du wysiwyg",
"No Additionnal Sort" => "Pas de tri additionnel",
"Development Notice" => "Avis de développement",
"Using comments below wiki pages" => "Utiliser les commentaires en bas des pages wiki",
...
"Administrator, can manage users groups and permissions, and all features" => "L'administrateur peut gérer les utlisateurs, les groupes, les droits d'accès ainsi que toutes les fonctionnalités",
"Can add objects to the category" => "Droit d'ajouter des objets à une catégorie",
...
"Can change pending tracker items" => "Droit de modifier les éléments des formulaires en attente",
...
"Can invite user to groups" => "Droit d'inviter des utilisateurs dans des groupes",
...
"Can view referrer stats" => "Droit de voir les statistiques des « referrer »",
...
"Trust all user inputs including plugins (no security checks)" => "Faire confiance à toutes les saisies de l'utilisateur y compris les plugins (aucune vérification de sécurité)",
"User can administer modules" => "Droit d'administrer les modules",
"feature articles" => "fonctionnalité articles",
"feature article comments" => "fonctionnalité commentaires d'article",
"feature blogs" => "fonctionnalité blogues",
"feature calendar" => "fonctionnalité calendrier",
"feature categories" => "fonctionnalité catégories",
"feature contact" => "fonctionnalité contact",
"feature forums" => "fonctionnalité forums",
"feature freetags" => "fonctionnalité freetags",
"feature jquery ui" => "fonctionnalité jquery ui",
"feature search fulltext" => "fonction de recherche fulltext",
"feature sheet" => "fonctionnalité feuille de calcul",
"feature stats" => "fonctionnalité statistiques",
"feature webmail" => "fonctionnalité webmail",
"generate password" => "générer le mot-de-passe",
"server timezone" => "fuseau horaire du serveur",
"  Strength: Average" => "Qualité: Moyenne",
" Strength: Strong" => "Qualité: Forte",
" Strength: Very Strong" => "Qualité: Vraiment forte",
" Strength: Very Weak" => "Qualité: Vraiment faible",
" Strength: Weak" => "Qualité: Faible",
"Passwords match" => "Le mot de passe correspond",
"Please click on the following link to confirm you wish to reset your password and go to the screen where you must enter a new \\\"permanent\\\" password. Please pick a password only you will know, and don't share it with anyone else" => "Veuillez cliquer sur le lien ci-dessous pour confirmer votre intention de réinitialiser votre mot de passe. Vous serez redirigé vers une page où vous devrez saisir un nouveau mot de passe \\\"permanent\\\". Ne partagez pas ce mot de passe.",
"Quick permissions" => "Permissions rapides",
"Use with care!" => "Utilisez avec soins !",
...
"Failed to validate captcha" => "La validation du captcha a échouée",
"Captcha ID field is missing" => "Le champ ID du Captcha est manquant",
"Get a visual challenge" => "Challenge visuel",
"Get an audio challenge" => "Challenge audio",
"Get a new challenge" => "Nouveau challenge",
...
"Cclite error" => "Erreur dans Cclite",
"Cclite payment initiated on %0" => "Payement Cclite initié à %0",
...
"Id" => "ID",
"Top" => "Racine",
"Between heading and body" => "Entre l'en'tête et la corps",
...
"Word length of the captcha image" => "Longeur du mot de l'image captcha",
...
"Use LDAP information when creating user in Tiki" => "Utiliser les informations LDAP à la création des utilisateurs dans Tiki",
"Force CAS logout when the user logout from tiki" => "Force la déconnexion CAS lors de la déconnexion de Tiki",
...
"Never" => "Jamais",
"1 hour" => "1 heure",
"Categories used in templates (TPL)" => "Catégories utilisées dans les templates (TPL)",
...
"Replace existing geocode if any" => "Remplacer le géocode le cas échéant",
"Use approximate geocode location" => "Utiliser une localisation geocode approximative",
...
"Method to Open Directory Links" => "Méthode pour ouvrir les répertoires de liens",
...
"Tiki-indexed Search" => "Recherche Tiki indexée",
"Freetags" => "Mots-clés",
...
"Shoutbox" => "Mégaphone",
"Maps" => "Cartes",
"Requires mapserver" => "Nécessite mapserver",
...
"Experimental (Requires AJAX)" => "Expérimental (AJAX requis)",
...
"If you are using Apache, you can rename _htaccess to .htaccess to get Short URLs" => "Si vous utilisez Apache, vous pouvez renommer _htaccess en .htaccess afin obtenir des URL courtes",
...
"Sort in fancytable plugin" => "Tri dans le plugin fancytable",
...
"History all instead of only page data, description, and change comment" => "Historique, tout, en plus du texte ajoute la description et les commentaires de changement",
...
"Use wiki page staging and approval" => "Utiliser le système d'approbation des pages wiki",
"This feature is experimental" => "Cette fonctionnalité est expérimentale",
"Allows wiki pages to be staged (drafted) before they are approved (published)" => "Permet la rédaction de pages wiki avant leur approbation (publication)",
...
"Allow users to invite new users by mail to register on this tiki" => "Autoriser les utilisateurs à inviter de nouveaux utilisateurs par mail pour s'inscrire sur ce tiki",
...
"Feeed author email" => "Email de l'auteur du flux",
...
"RSS feed for individual trackers items" => "Flux RSS pour chaque élément de formulaire",
"Calendar events" => "Évènements du calendrier",
"RSS feed for calendar events" => "Flux RSS pour les évènements du calendrier",
"Directories" => "Répertoires",
"RSS feed for directories" => "Flux RSS pour les répertoires",
"RSS feed for maps" => "Flux RSS pour les cartes",
...
"Keep always the same fileId when replacing a file with archive" => "Conserver le même fileId lors du remplacement d'un fichier par une archive",
...
"Kaltura \"User\"" => "\"Utilisateur\" Kaltura",
...
"If you don't know better, use '_yourPartnerID'" => "Si vous hésitez, utilisez '_yourPartnerID'",
...
"village size" => "taille des villages",
...
"Use thread title instead" => "Utilisez le titre d'enfilade à la place",
"Use image title instead" => "Utiliser le titre de l'image à la place",
"Use individual page description for Wiki pages instead" => "Utiliser la description individuelle de la page wiki à la place",
...
"Cclite Enable Payments" => "Cclite activer les payements",
...
"Value provided in minutes" => "Valeur entrée en minutes",
...
"Prefix to include before the static files, for example: http://cdn.example.com" => "Prefix à inclure avant les fichiers statiques, par exemple : http://cdn.example.com",
...
"Enable edit plugin icons" => "Activer l'icone d'édition du plugin",
...
"Toggle display of section and plugin edit icons" => "Activer l'icone d'édition par section et des plugins",
...
"Approved" => "Approuvé",
"(mandatory for feature to work)" => "(obligatoire pour le bon fonctionnement de la fonctionnalité)",
"Out-of-sync" => "Désynchronisé",
"Global cache time for the plugin snarf in seconds" => "Durée globale de mise encache pour le plugin snarf en secondes",
"Default cache time for the plugin snarf" => "Durée par défaut de mise encache pour le plugin snarf",
...
"Applying profile" => "Application du profil",
...
"No Tabs" => "Affichage sans onglet",
"Tip" => "Astuce",
"This edit session will expire in" => "Cette session d'édition va expirer dans",
"There is an autosaved version of this content, to use it instead of this saved one" => "Il existe une version auto-sauvée de ce contenu, pour l'utiliser à la place de cette version sauvegardée",
"If you want the saved version instead of this autosaved draft" => "Si vous désirez la version sauvegardée et non ce brouillon auto-sauvé",
"click here" => "cliquer ici",
"AutoSave" => "Sauvegarde automatique",
"<strong>Thank you for trying the new ckeditor implementation for Tiki 6</strong><br /><br />" => "<strong>Merci d'utiliser la nouvelle implémentation de CKEditor pour Tiki 6</strong><br /><br />",
"Ckeditor Development Notice" => "Note de développement pour Ckeditor",
...
"Click here to go to Edit Languages" => "Clicquez ici pour aller à l'édition des langues",
...
"PHPLayersMenus are not enabled on this site" => "Les menus PHPLayers ne sont pas activés sur ce site",
" (found in " => " (trouvé dans",
"(not found in an admin panel)" => "(trouvé dans aucun panneau d'admininistration)",
"Select All" => "Tout sélectionner",
"Invert Sort" => "Inverser le tri",
"No rows found" => "Aucune ligne trouvée",
"Toggle sections" => "Basculer de section",
"Show only selected" => "N'affiche que les sélectionnés",
...
"Unknown conversion" => "Conversion inconnue",
"text" => "texte",
...
"arts" => "articles",
"blogs" => "blogues",
"Plugin execution pending approval" => "Plugin en attente d'approbation",
...
"Add Event to Google Calendar" => "Ajouter l'événement au calendier Google",
"One" => "Un",
"Two" => "Deux",
"Three" => "Trois",
...
"Can admin kaltura feature" => "Droit d'administrer la fonctionnalité Kaltura",
...
"Can administer payments" => "Droits d'administrer les payements",
...
"Can create new categories" => "Droit de créer de nouvelles catégories",
...
"Can delete kaltura entry" => "Droit d'effacer une entrée Kaltura",
"Can delete mapfiles" => "Droit de supprimer des fichiers-carte",
"Can download files" => "Droit de télécharger des fichiers",
"Can download kaltura entry" => "Droit de tlécharger une entrée Kaltura",
...
"Can edit information of kaltura entry" => "Droit d'éditer les information d'une entrée Kaltura",
...
"Can enter manual payments" => "Droit d'entrer un payement manuel",
...
"Can invit users by email, and include them in groups" => "Droit d'inviter des utilisateurs par mail et les inclure dans des groupes",
...
"Can list kaltura entries" => "Droit de lister les entrées Kaltura",
...
"Can promote a page (email, twitter, facebook)" => "Droit de promouvoir une page (email, twitter, facebook)",
...
"Can remove objects from the category" => "Droit de retirer des éléments de la catégorie",
...
"Can view kaltura entry" => "Droit de voir les entrées kaltura",
...
"error reporting adminonly" => "rapporter les erreurs seulement à l'admin",
"language" => "langue",
"sender email" => "Email de l'expéditeur",
...
"New blog post: {\$mail_title}, \"{\$mail_post_title}\", by {\$mail_user|username} at {\$mail_date|tiki_short_datetime}" => "Nouvelle publication dans le blogue: {\$mail_title}, \"{\$mail_post_title}\", par {\$mail_user|username} à {\$mail_date|tiki_short_datetime}",
...
"For help, visit <a href=\"http://doc.tiki.org\" title=\"Tikiwiki Documentation\" target=\"_blank\">http://doc.tiki.org</a>" => "Pour de l'aide, visitez <a href=\"http://doc.tiki.org/fr\" title=\"Documentation Tikiwiki\" target=\"_blank\">http://doc.tiki.org/fr</a>",
...
"Paste content here" => "Coller le contenu ici",
"Image Galleries" => "Galeries d'images",
"Calendars" => "Calendriers",
"Entire Site" => "Tout le site",
"Image Gals" => "Galeries d'images",
"Search Help" => "Aide pour la recherche",
"Tweet with twitter" => "Tweet sur twitter",
...
"Logout" => "Déconnexion",
"Refresh" => "Actualiser",
"Refresh (non-ajax)" => "Rafraîhir (non-ajax)",
...
"Batch upload" => "Rapatriement par lot",
...
"Manage Credits" => "Gérer les Credits",
"Creation Date" => "Date de création",
"Expiration Date" => "Date d'expiration",
"Used" => "Utilisé",
"(level credits always 0)" => "(niveau de credits toujours 0)",
...
"Shows number of attachments of the all thread in forum list" => "Indique le nombre de pièces jointes de toute l'enfilade dans la liste des forums",
...
"Set thread preferences" => "Configurer les préférences des enfilades",
"Show threads preferences" => "Afficher les préférences des enfilades",
"hide threads preferences" => "Cacher les préférences des enfilades",
...
"Internationalization and localization - mulitlingual features" => "Internationalisation et localisation - fonctionnalités multi-langue",
...
"Give only one value (width or height) to keep the image proportions" => "Ne donner qu'une seule valeur (hauteur ou largeur) pour garder les proportions de l'image",
"Import CSV file" => "Importer un fichier CSV",
"File format: title,authorName,heading,body,lang,user" => "Format du fichier: titre,NomAuteur,rubrique,corps,langue,utilisatuer",
"List Articles" => "Liste des articles",
...
"Submit site" => "Soumetter le site",
"Help Tiki spread" => "Aider à la diffusion de Tiki",
...
"Score is disabled" => "Le score est désactivé",
"Enable now" => "Activer maintenant",
...
"Select which items to display when listing galleries: " => "Sélectionner les informations que vous souhaitez voir apparaître lors de l'affichage des galeries ",
"Admin Gallery Listings" => "Listes des galeries",
...
"Edit or export/import Languages" => "Éditer, importer ou exporter les langues",
...
"Refresh files search index now" => "Rafraichir les index de recherche de fichiers",
...
"Twitter Settings" => "Configuration de Twitter",
"Facebook Settings" => "Configuration de Facebook",
"bit.ly Settings" => "Configuration de bit.ly",
...
"Enable" => "Activer",
"Disable edit plugin icon (make plugin inline)" => "Désactive l'icone d'édition du plugin (plugin inline)",
"Plugin Aliases" => "Alias de plugin",
...
"Composed Plugin Arguments" => "Arguments de plugin composé",
"Pattern" => "Modèle",
...
"Use CSS menu" => "Utliser les menus CSS",
...
"Function" => "Fonction",
"To disallow a function, add a disable_functions=exec,passthru for instance in your php.ini" => "Pour interdire une fonction, ajouter  disable_functions=exec,passthru par exemple dans votre fichier php.ini",
...
"Plugin name" => "Nom du plugin",
"Add a new custom tool" => "Ajouter un nouvel outil perso.",
...
"Position of field in list" => "Position du champ dans la liste",
...
"Wiki page to display an item" => "Page Wiki pour l'affichage d'un élément",
...
"Status changes list" => "Liste des changemet d'états",
"Status changes" => "Changements d'état",
"After creation" => "Après création",
"After last modification" => "Après la dernière modification",
"Warn creator of an upcoming status change" => "Avertir le créateur d'un changement d'état à venir",
"before" => "avant",
...
"Show topic or own image" => "Afficher l'image propre ou celle du sujet",
"Show avatar" => "Afficher l'avatar",
"Show author's avatar" => "Afficher l'avatar de l'auteur",
"Show author name" => "Afficher le nom de l'auteur",
"Show publish date" => "Afficher la date de publication",
"Show expire date" => "Afficher la date d'expiration",
"Show reads" => "Afficher le nombre de lecture",
"Show the number of times the article was read" => "Afficher le nombre de fois que l'article a été lu",
"Show the size of the article" => "Afficher la taille de l'article",
"Show topline" => "Afficher le surtitre",
"Show a small title over the title" => "Afficher un petit titre au-dessus du titre",
"Show subtitle" => "Afficher le sous-titre",
"Show the subtitle" => "Afficher le sous-titre",
"Show source" => "Afficher le code source",
"Show link to source after article body" => "Afficher le lien vers la source après le corps de l'article",
"Show Image Caption" => "Afficher la légende de l'image",
"Show a legend under the image" => "Afficher une légende en dessus de l'image",
"Show Language" => "Afficher la langue",
"Show the language" => "Afficher la langue",
...
"If others post to blog, Author should always be Owner" => "L'auteur du bloge doit toujours être le propriètaire des messages",
...
"Beware that when importing a language, all translations in the database for that language are deleted." => "Attention, lors de l'importation d'une langue, toutes les traductions dans la base de données pour cette langue sont supprimées.",
...
"Upload to Kaltura" => "Rapatrié vers Kaltura",
"Upload Successful" => "Succès du rapatiement",
"You have successfully added {\$count} new entry/entries" => "Vous avez ajouter avec succès {\$count} nouvelle(s) entrée(s)",
"Add more media" => "Ajouter des media",
"Advanced Editor" => "Éditeur advancé",
...
"Wiki plugin code" => "Code du plugin Wiki",
...
"If an object is not listed in the section below, then only the global perms are on" => "Si un objet n'est pas répertorié dans la section ci-dessous, alors seules les permissions globales sont actives",
"category or object permissions" => "Permissions de catégories et d'objets",
"If an object is not listed in this section, then only the global perms are on" => "Si un objet n'est pas répertorié dans cette section, alors seules les permissions globales sont actives",
...
"Feature name" => "Fonctionnalité",
"Quick Permissions" => "Permissions rapides",
"Assign Quick-Permissions to this object" => "Attribuer des permissions rapides pour cet objet",
"Although permissions will be set as expected using this form, it doesn't necessarily show the current permissions reliably." => "Bien que les autorisations seront fixés comme prévu en utilisant ce formulaire, il ne montrent pas nécessairement les permissions en cours de manière fiable.",
