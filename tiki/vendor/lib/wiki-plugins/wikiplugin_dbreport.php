...
// $Id: wikiplugin_dbreport.php 26965 2010-05-07 13:07:41Z sylvieg $
	...
	return array(
		...
		'params' => array(
			...
			'wiki' => array(
				...
				'description' => tra('0|1, parse wiki syntax within the report.'),
			),
			'debug' => array(
				'required' => false,
				'name' => tra('Debug'),
				'description' => tra('0|1, display the parsed report definition.'),
			),
		),
	);
}
