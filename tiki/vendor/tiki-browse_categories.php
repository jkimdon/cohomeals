...
// $Id: tiki-browse_categories.php 29935 2010-10-10 23:59:52Z lindonb $
...
function add_watch_icons($descendants, $usercatwatches, $requestid, $categid, $deep, $user) {
	...
	$eye_add = 	'<a href="tiki-browse_categories.php?parentId=' . $requestid . '&amp;watch_event=category_changed&amp;watch_object=' . $categid . '&amp;deep=' . $deep . '&amp;watch_action=add" class="icon"><img src="pics/icons/eye.png" alt="'.tra("Watch this category").'" width="14" style="margin-right:3px;margin-bottom:0.052cm" height="14" border="0" title="'.tra("Watch this category").'" class="catname" /></a>';
