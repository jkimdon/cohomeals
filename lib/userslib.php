...
// $Id: userslib.php 63886 2017-09-20 16:48:17Z jonnybradley $
	...
	*/
	...
	private function get_raw_permissions()
	{
		...
		$permissions = array(
			...
			array(
				'name' => 'tiki_p_view_meals',
				'description' => tra('Can view meal software'),
				'level' => 'registered',
				'type' => 'meals',
				'admin' => false,
			...
			array(
				'name' => 'tiki_p_admin_meals',
				'description' => tra('Can admin meal software'),
				'level' => 'admin',
				'type' => 'meals',
				'admin' => true,
				'prefs' => array('feature_cohomeals'),
