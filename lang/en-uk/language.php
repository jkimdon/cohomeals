...
"Email attribute" => "E-mail attribute",
"Group DN" => "Group DN",
...
"Allows tags on pages and various objects to be set within the website and generate tag cloud navigation patterns" => "Allows to set tags on pages and various objects within the website and generate tag cloud navigation patterns",
"Action Log" => "Action Log",
"Provides ability to track what users are doing and produce reports on a per-user or per-category basis" => "Allows to keep track of what users are doing and produce reports on a per-user or per-category basis",
...
"Allows the menu options that can be seen by a user to be controlled" => "Allows to control the menu options that can be seen by a user",
...
"Going beyond Backlinks, allows some semantic relationships to be defined between wiki pages" => "Going beyond Backlinks, allows to define some semantic relationships between wiki pages",
...
"Allows domain names to be mapped to perspectives and simulate multiple domains hosted on the same instance" => "Allows to map domain names to perspectives and simulate multiple domains hosted on the same instance",
...
"3Mb" => "3Mb",
"Unlimited" => "Unlimited",
"Include a flag by each email to quickly flag/un-flag them" => "Include a flag by each e-mail to quickly flag/un-flag them",
"LastModif" => "LastModif",
...
"Can subscribe many emails at once (requires tiki_p_subscribe email)" => "Can subscribe many e-mails at once (requires tiki_p_subscribe email)",
...
"txt file, one email per line" => "txt file, one e-mail per line",
